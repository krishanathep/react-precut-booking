...
function ViewEstimateManagement() {
  const { id } = useParams();
            ...
            <div className="row mb-2">
              ...
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  ...
                  <li className="breadcrumb-item active">Special-design-view</li>
                </ol>
              </div>
            </div>
          </div>
...
export default ViewEstimateManagement;
